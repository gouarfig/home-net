...
class WeatherRepository {
    ...
    public function saveWeather(Weather $weather) {
        ...
        $query .= "VALUES (";
        $query .= $weather->weather_type_id != '' ? $weather->weather_type_id : 'NULL' . ", ";
        $query .= $weather->temperature != '' ? $weather->temperature : 'NULL' . ", ";
        $query .= $weather->pressure != '' ? $weather->pressure : 'NULL' . ", ";
        $query .= $weather->humidity != '' ? $weather->humidity : 'NULL' . ", ";
        $query .= $weather->wind_speed != '' ? $weather->wind_speed : 'NULL' . ", ";
        $query .= $weather->gust_speed != '' ? $weather->gust_speed : 'NULL' . ", ";
        $query .= $weather->wind_direction != '' ? $weather->wind_direction : 'NULL' . ", ";
        $query .= $weather->clouds != '' ? $weather->clouds : 'NULL' . ", ";
